...
`r tufte::newthought("The dataset we use")` stems from the [Bank of England Research datasets](https://www.bankofengland.co.uk/statistics/research-datasets).
...
`r tufte::newthought("For this dataset")` the Bank of England asked `r prettyNum(nrow(inflation), big.mark = ".", decimal.mark = ",")` people for their opinion on the **perceived and expected inflation**.
